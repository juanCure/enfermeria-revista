<?php /* Smarty version 2.6.25-dev, created on 2018-04-12 12:52:15
         compiled from frontend/objects/article_summary.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'frontend/objects/article_summary.tpl', 26, false),array('function', 'translate', 'frontend/objects/article_summary.tpl', 27, false),array('function', 'call_hook', 'frontend/objects/article_summary.tpl', 82, false),array('modifier', 'escape', 'frontend/objects/article_summary.tpl', 27, false),array('modifier', 'strip_unsafe_html', 'frontend/objects/article_summary.tpl', 34, false),array('modifier', 'date_format', 'frontend/objects/article_summary.tpl', 55, false),)), $this); ?>
...
?>
				<?php if ($this->_tpl_vars['primaryGenreIds']): ?>
					...
					<?php if (! $this->_tpl_vars['file'] || ! in_array ( $this->_tpl_vars['file']->getGenreId() , $this->_tpl_vars['primaryGenreIds'] )): ?>
						<?php continue; ?>
					<?php endif; ?>
				<?php endif; ?>
				<li>

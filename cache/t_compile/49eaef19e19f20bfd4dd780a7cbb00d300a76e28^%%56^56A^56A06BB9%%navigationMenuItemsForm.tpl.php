<?php /* Smarty version 2.6.25-dev, created on 2018-04-12 13:34:25
...
" />
		...
		<?php $this->_tag_stack[] = array('fbvFormSection', array('id' => 'menuItemTypeSection','title' => "manager.navigationMenus.form.navigationMenuItemType",'for' => 'menuItemType')); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'select','id' => 'menuItemType','from' => $this->_tpl_vars['navigationMenuItemTypeTitles'],'selected' => $this->_tpl_vars['menuItemType'],'label' => "manager.navigationMenus.form.navigationMenuItemTypeMessage",'translate' => false), $this);?>

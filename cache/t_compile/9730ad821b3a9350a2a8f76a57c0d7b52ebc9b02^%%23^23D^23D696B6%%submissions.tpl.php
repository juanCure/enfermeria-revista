<?php /* Smarty version 2.6.25-dev, created on 2018-04-12 13:34:12
...
unset($_smarty_tpl_vars);
 ?>
			...
			<?php echo ((is_array($_tmp=$this->_tpl_vars['currentContext']->getLocalizedSetting('copyrightNotice'))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
